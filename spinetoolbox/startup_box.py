...
"""Contains a class for the Startup box window of Spine Toolbox."""
...
class StartUpMainWindow(QMainWindow):
    def __init__(self):
        ...
        # Set the window icon to the PNG version (to be changed)
    ...
    def setup_central_content(self, main_layout):
        '''
        Set the central content of the window
        '''
    ...
    def toggle_dropdown(self):
        '''
        Ensures the dropdown items proper opening
        '''
    ...
    def create_dropdown_cards_beginners(self):
        ...
        '''
        Path to images to be set - temporary path
        ...
        self.card4 = self.create_card(
            "Tutorial 4 description", "image_path_for_tutorial4.png", "Open", self.open_tutorial4
        )

        self.card5 = self.create_card(
            "Tutorial 5 description", "image_path_for_tutorial5.png", "Open", self.open_tutorial5
        )

        self.card6 = self.create_card(
            "Tutorial 6 description", "image_path_for_tutorial6.png", "Open", self.open_tutorial6
        )
    ...
    def add_subitems(self):
        '''
        Populate the left menu dropdown (to be updated)
        '''
